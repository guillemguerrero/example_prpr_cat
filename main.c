...
int main () {
	...
	printf("Hola alumn@s GUAPOS de Projectes!!<3 :)\n");
...
regar el huerto, y de allí se a repartía en cuatro brazos.
...
(Cristo) herirá la cabeza de la serpiente — Se explica el papel de la
...
b astuta, más que todos los animales del campo que Jehová Dios
había hecho, la cual dijo a la
mujer: ¿Conque Dios os ha dicho: No comáis de ningún árbol
del huerto?
...
en que comáis de él serán abiertos vuestros a ojos y seréis como
...
la mujer: ¿Qué es lo que has hecho? Y dijo la mujer: La
	return 0;
}
